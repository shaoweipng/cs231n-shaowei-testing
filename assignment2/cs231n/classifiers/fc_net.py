...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    hidden_layer, affine_relu_cache = affine_relu_forward(X, W1, b1)
    ...
    affine2_dx, dW2, db2 = affine_backward(dscores, affine_cache)
    _, dW1, db1 = affine_relu_backward(affine2_dx, affine_relu_cache)
